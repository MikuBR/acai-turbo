    ...
    <div className="fixed inset-0 bg-surface z-[1000] flex items-center justify-center">
      <div className="bg-card p-8 rounded-2xl border border-border w-80 shadow-2xl text-center">
        ...
        <input 
          type="password" 
          placeholder="****"
          className="w-full bg-surface-light border border-border p-4 rounded-xl text-center text-2xl tracking-[1em] text-primary outline-none focus:border-emerald-500 mb-6"
          autoFocus
          ref={inputRef}
