...
export default function InventoryForm({ inventoryForm, setInventoryForm, products, onSubmit, inputTheme }) {
  return (
    <form onSubmit={onSubmit} className="space-y-3 select-text">
      ...
      <div>
        <label className="text-[9px] text-gray-600 font-bold uppercase ml-1 mb-1 block">Quantidade</label>
      ...
      <div>
        <label className="text-[9px] text-gray-600 font-bold uppercase ml-1 mb-1 block">Estoque Mínimo</label>
