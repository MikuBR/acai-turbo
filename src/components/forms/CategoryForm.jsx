...
export default function CategoryForm({ newCatName, setNewCatName, categories, onAdd, onDelete, }) {
  return (
    <section className="mb-10">
      <h3 className="text-[10px] font-bold text-success uppercase mb-4 tracking-widest border-b border-border pb-2">Gerenciar Categorias</h3>
      <div className="flex gap-2 mb-4">
        ...
        <button
          onClick={onAdd}
          className="p-2 bg-success text-white rounded-lg hover:bg-success transition-all flex items-center justify-center shrink-0"
        >
          <Plus size={18} />
        </button>
      </div>
